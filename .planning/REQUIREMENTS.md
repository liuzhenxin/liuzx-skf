...
- [x] **SVC-03**: The installer applies restrictive permissions to the install directory so a non-administrator cannot replace the loaded executable or DLL
- [x] **SVC-04**: Operator can install, run, upgrade over a running installation, and uninstall without leaving a stale service registration or locked files
